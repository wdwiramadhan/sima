                ...
                <div class="col">
                    <div class="card">
                        <div class="row mx-0 card-header">
                            <div class="col">
                                <div class="card-title">Edit Rencana Kegiatan</div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control form-control" id="taSelect" name="tahun_anggaran" value="<?= set_value('tahun_anggaran') ?>">
                                        ...
                                        <?php if ($rencanakegiatan['tahun_anggaran'] == $ta['tahun']) : ?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <select class="form-control form-control" id="programSelect" name="program" value="<?= set_value('program') ?>">
                                        ...
                                        <?php if ($rencanakegiatan['program'] == $prgm['nama_program']) : ?>
                                        <option value="<?= $rencanakegiatan['program'] ?>" selected="selected"><?= $rencanakegiatan['program'] ?></option>
                                        <?php else : ?>
                                        <option value="<?= $rencanakegiatan['program'] ?>"><?= $rencanakegiatan['program'] ?></option>
                                        <?php endif; ?>
                                        <?php endforeach; ?>
                                    </select>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="nama_kegiatan" class="form-control" id="nama_kegiatan" name="nama_kegiatan" placeholder="Masukan nama kegiatan" value="<?= $rencanakegiatan['nama_kegiatan'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="tujuan" name="tujuan" placeholder="Masukan tujuan" value="<?= $rencanakegiatan['tujuan'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="sasaran" name="sasaran" placeholder="Masukan sasaran" value="<?= $rencanakegiatan['sasaran'] ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    <input type="date" class="form-control" id="pelaksanaan" name="pelaksanaan" value="<?= $rencanakegiatan['pelaksanaan'] ?>">
                            ...
                            <div class=" form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="penanggungjawab" name="penanggungjawab" placeholder="Masukan penanggungjawab" value="<?= $rencanakegiatan['penanggungjawab'] ?>">
                                    <?= form_error('penanggungjawab', '<small class="text-danger pl-3">', '</small>') ?>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="proposal_kegiatan" class="col-sm-2 col-form-label">Proposal kegiatan</label>
                                <div class="col-sm-10">
